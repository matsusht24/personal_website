...
const project_list:projectType[]= [
  {
    ...
    description: 
    `A web-based companion tool designed to assist players in Hearthstone Battlegrounds
  ...
  },
  {
    ...
    description: 
    `Part of UP's first 12-member interdisciplinary team to design and build a Formula
  ...
  },
  {
    ...
    description: 
    `Developed a mobile-friendly gradebook interface for a Malawi-based educational 
